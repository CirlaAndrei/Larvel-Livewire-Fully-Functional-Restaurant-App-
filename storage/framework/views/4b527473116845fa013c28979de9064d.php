...
<nav class="nav">
        ...
        <div class="Sign-In-Page">
            ...
            <form class="form-sign" action="<?php echo e(route('login')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                    <div class="row2-log">
                        <label for="email" value="<?php echo e(('Email')); ?>" />
                        <input class="input-sign-email" id="email" type="email" placeholder="Email / Phone Number"  name="email":value="old('email')" required autofocus autocomplete="username">
                    </div>
                    <div class="row3-log">
                        <label for="password" value="<?php echo e(('Password')); ?>" />
            ...
            <div class="butoane-create-log">
                <button onclick="window.location.href='<?php echo e(route('google.redirect')); ?>'" class="btn-google">
                    <img src="imagini/Iconita-Google.svg" class="btn-icon"> Google
            </button>
...
</html><?php /**PATH C:\xampp\htdocs\Restaurant - Copy\resources\views/auth/login.blade.php ENDPATH**/ ?>