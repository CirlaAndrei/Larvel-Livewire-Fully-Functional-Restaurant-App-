                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = Laravel\Jetstream\Jetstream::$permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center space-x-2 cursor-pointer">
                                ...
                                <span class="text-sm text-gray-700"><?php echo e(ucfirst($permission)); ?></span>
                            </label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-message','data' => ['class' => 'mr-3','on' => 'created']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                    ...
                    <div class="space-y-6">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->user->tokens->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $token): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between">
                                <div class="break-all"><?php echo e($token->name); ?></div>
...
<?php $component->withAttributes(['wire:model.live' => 'displayingToken']); ?>
         <?php $__env->slot('title', null, []); ?> <?php echo e(__('API Token')); ?> <?php $__env->endSlot(); ?>

         <?php $__env->slot('content', null, []); ?> 
            <div><?php echo e(__('Please copy your new API token. For your security, it won\'t be shown again.')); ?></div>
...
<?php $component->withAttributes(['wire:model.live' => 'managingApiTokenPermissions']); ?>
         <?php $__env->slot('title', null, []); ?> <?php echo e(__('API Token Permissions')); ?> <?php $__env->endSlot(); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['class' => 'ml-3','wire:click' => 'updateApiToken','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes(['wire:model.live' => 'confirmingApiTokenDeletion']); ?>
         <?php $__env->slot('title', null, []); ?> <?php echo e(__('Delete API Token')); ?> <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['class' => 'ml-3','wire:click' => 'deleteApiToken','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\xampp\htdocs\Restaurant - Copy\resources\views/api/api-token-manager.blade.php ENDPATH**/ ?>