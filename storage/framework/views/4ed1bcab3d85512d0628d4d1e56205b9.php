...
<body class="body-dashboard">
        ...
        <div class="flex-sectiune-dashboard">
            <div class="left-bar">
                ...
                <a href class="flex-dashboard <?php echo e(request()->routeIs('ecommerce') ? 'active' : ''); ?>">
                    <img class="dashboard-icon" src="<?php echo e(asset('imagini/kart2.svg')); ?>" alt="admin">
                    <p class="p-dashboard <?php echo e(request()->routeIs('ecommerce') ? 'active' : ''); ?>">E-commerce</p>
                </a>
                <div class="flex-dashboard">
...
</html><?php /**PATH C:\xampp\htdocs\Restaurant - Copy\resources\views/e-commerce.blade.php ENDPATH**/ ?>